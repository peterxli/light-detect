...
training_xml_path = os.path.join(wheel_folder, "training.xml")
testing_xml_path = os.path.join(wheel_folder, "testing.xml")
...
for f in glob.glob(os.path.join(wheel_folder, "*.jpg")):
...
image = dlib.load_rgb_image(wheel_folder + '/2008_002506.jpg')
...
images = [dlib.load_rgb_image(wheel_folder + '/2008_002506.jpg'),
          dlib.load_rgb_image(wheel_folder + '/2009_004587.jpg')]
